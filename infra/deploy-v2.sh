...
WORKLOADS=(
    ...
    "mycelium-channel-router;channel-router;channel-router,agent-registry;wasi:keyvalue:store|wasi:config:store|wasi:logging:logging|wasmcloud:messaging:consumer,handler,types:subscriptions=mycelium.channel.telegram.raw,mycelium.step.result;${POOL_SIZE_DEFAULT}"
